...
void Frame_Base::parsimUnpack(omnetpp::cCommBuffer *b)
{
    ...
    doParsimUnpacking(b,this->seq_nr);
    doParsimUnpacking(b,this->payload);
    doParsimUnpacking(b,this->parity_byte);
    doParsimUnpacking(b,this->kind);
}

int Frame_Base::getSeq_nr() const
{
    return this->seq_nr;
}

void Frame_Base::setSeq_nr(int seq_nr)
{
    this->seq_nr = seq_nr;
}
...
const char * Frame_Base::getParity_byte() const
{
    return this->parity_byte.c_str();
}

void Frame_Base::setParity_byte(const char * parity_byte)
{
    this->parity_byte = parity_byte;
}

int Frame_Base::getKind() const
{
    return this->kind;
}

void Frame_Base::setKind(int kind)
{
    this->kind = kind;
}
...
unsigned int FrameDescriptor::getFieldTypeFlags(int field) const
{
    ...
    static unsigned int fieldTypeFlags[] = {
        FD_ISEDITABLE,    // FIELD_seq_nr
        FD_ISEDITABLE,    // FIELD_payload
        FD_ISEDITABLE,    // FIELD_parity_byte
...
int FrameDescriptor::findField(const char *fieldName) const
{
    ...
    if (strcmp(fieldName, "seq_nr") == 0) return baseIndex + 0;
    if (strcmp(fieldName, "payload") == 0) return baseIndex + 1;
    if (strcmp(fieldName, "parity_byte") == 0) return baseIndex + 2;
    if (strcmp(fieldName, "kind") == 0) return baseIndex + 3;
...
std::string FrameDescriptor::getFieldValueAsString(omnetpp::any_ptr object, int field, int i) const
{
    ...
    Frame_Base *pp = omnetpp::fromAnyPtr<Frame_Base>(object); (void)pp;
    switch (field) {
        case FIELD_seq_nr: return long2string(pp->getSeq_nr());
        case FIELD_payload: return oppstring2string(pp->getPayload());
        case FIELD_parity_byte: return oppstring2string(pp->getParity_byte());
...
void FrameDescriptor::setFieldValueAsString(omnetpp::any_ptr object, int field, int i, const char *value) const
{
    ...
    Frame_Base *pp = omnetpp::fromAnyPtr<Frame_Base>(object); (void)pp;
    switch (field) {
        case FIELD_seq_nr: pp->setSeq_nr(string2long(value)); break;
        case FIELD_payload: pp->setPayload((value)); break;
        case FIELD_parity_byte: pp->setParity_byte((value)); break;
...
omnetpp::cValue FrameDescriptor::getFieldValue(omnetpp::any_ptr object, int field, int i) const
{
    ...
    Frame_Base *pp = omnetpp::fromAnyPtr<Frame_Base>(object); (void)pp;
    switch (field) {
        case FIELD_seq_nr: return pp->getSeq_nr();
        case FIELD_payload: return pp->getPayload();
        case FIELD_parity_byte: return pp->getParity_byte();
...
void FrameDescriptor::setFieldValue(omnetpp::any_ptr object, int field, int i, const omnetpp::cValue& value) const
{
    ...
    Frame_Base *pp = omnetpp::fromAnyPtr<Frame_Base>(object); (void)pp;
    switch (field) {
        case FIELD_seq_nr: pp->setSeq_nr(omnetpp::checked_int_cast<int>(value.intValue())); break;
        case FIELD_payload: pp->setPayload(value.stringValue()); break;
        case FIELD_parity_byte: pp->setParity_byte(value.stringValue()); break;
